...
const App = () => {
  return (
    <Canvas shadows camera={{ position: [-200, 175, 200]}} style={{ background: '#272727' }}>
      ...
      <LoadModel url={url + 'bounty_board_w_resume'} scale={[10, 10, 10]} rotation={[0, -1.575, 0]} position={[52, -5, 150]} canHover={true}/>
      <LoadModel url={url + 'lightpost'} scale={[4.5, 4.5, 4.5]} position={[-90, -5, 120]} rotation={[0, 2.5, 0]}/>
      <LoadModel url={url + 'pile_of_books'} scale={[.15, .15, .15]} position={[48, 51.75, -14.4]} rotation={[-1.6, -1.5, 0]} canHover={true}/>
      <LoadModel url={url + 'second_pile_of_books'} scale={[.15, .15, .15]} position={[48, 51.75, -8]} rotation={[-1.6, -1.5, 0]} canHover={true}/>
